...
$(function() {
    var macroMoleculeTables = $("#MacromoleculeTable .ProteinFeatureViewRow");

    // INITIALIZE PFV
    if (macroMoleculeTables.length > 0) {
        var togglePFVtarget = $("#MacromoleculeTable .ProteinFeatureViewRow:eq(0) .material-switch .togglePFV");
